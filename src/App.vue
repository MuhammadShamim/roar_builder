<template>
    <div id="frame">
        <sidebar-left :brand="brand"></sidebar-left>
        <app-main :brand="brand"></app-main>
    </div>
</template>

<script>
    import SideBarLeft from './components/sidebar/Left.vue'
    import AppMain from './components/body/AppMain.vue'
        ...
        data () {
            return {
                brand: {
                    ...
                    statusOptions: false,
                    name: 'LION',
                    image: 'http://localhost:8080/dist/lion_black.png',
                    version: '1.0.0',
                    expanded: false
                }
            }
